...
class NnLib:
    ...
    def convert_to_tensorrt(self,
        ...
        if model.fwk_type == NnFrameworkType.PYTORCH:
            torch_arch: NnArchitecture = model.arch
        ...
        if out_dir is not None:
            ...
            trt_basename: str = generate_tensorrt_basename(_model, basename)
        ...
        # TODO: put the following code in an Try-Except block
        trt_engine = None
        if onnx_model.arch.to_tensorrt is not None:
