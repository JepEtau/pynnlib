...
# Zhang, Kai and Li, Yawei and Liang, Jingyun and Cao, Jiezhang and Zhang,
#   Yulun and Tang, Hao and Timofte, Radu and Van Gool, Luc
...
class WMSA(nn.Module):
    ...
    # from https://github.com/cszn/SCUNet/blob/main/models/network_scunet.py
